...
model_names.append('efficientnetV2')
model_names.append('shufflenetV2')
model_names.append('mnasnet')
model_names.append('densenet')
model_names.append('googlenet')
model_names.append('resnext')
model_names.append('inception')
model_names.append('vgg')
model_names.append('wideresnet')
...
def main():
    ...
    original_trainset, _, _, _, _, testset, _, num_classes, class_names = \
    ...
    if args.arch == 'resnet50':
        ...
        model = torchvision.models.mobilenet_v2(pretrained=args.pretrained)
        model.fc = nn.Linear(dim_feature, num_classes)
    elif args.arch == 'efficientnetV2':
        model = torchvision.models.efficientnet_v2_l(pretrained=args.pretrained)
        model.fc = nn.Linear(dim_feature, num_classes)
    elif args.arch == 'shufflenetV2':
        model = torchvision.models.shufflenet_v2_x1_0(pretrained=args.pretrained)
        model.fc = nn.Linear(dim_feature, num_classes)
    elif args.arch == 'densenet':
        model = torchvision.models.densenet161(pretrained=args.pretrained)
    elif args.arch == 'resnext':
        model = torchvision.models.resnext50_32x4d(pretrained=args.pretrained)
    elif args.arch == 'googlenet':
        model = torchvision.models.googlenet(pretrained=args.pretrained)
        model.fc = nn.Linear(dim_feature, num_classes)
    elif args.arch == 'mnasnet':
        model = torchvision.models.mnasnet1_3(pretrained=args.pretrained)
        model.fc = nn.Linear(dim_feature, num_classes)
    elif args.arch == 'vgg':
        model = torchvision.models.vgg16_bn(pretrained=args.pretrained)
        model.fc = nn.Linear(dim_feature, num_classes)
    elif args.arch == 'inception':
        model = torchvision.models.inception_v3(pretrained=args.pretrained)
        model.fc = nn.Linear(dim_feature, num_classes)
    elif args.arch == 'wideresnet':
        model = torchvision.models.wide_resnet50_2(pretrained=args.pretrained)
        model.fc = nn.Linear(dim_feature, num_classes)
    else:
        print("=> creating model '{}'".format(args.arch))
